  ...
  ),
  {
    variants: {
      variant: {
        ...
        outline: cn(
          'border border-border bg-input/10 bg-none text-primary-foreground shadow-sm shadow-black/5 active:bg-input/70 dark:border-input/20 dark:active:bg-foreground/10',
          Platform.select({
  ...
  ),
  {
    variants: {
      variant: {
        ...
        outline: cn(
          'text-foreground group-active:text-accent-foreground dark:group-active:text-primary-foreground/30 dark:group-active:text-primary-foreground',
          Platform.select({ web: 'group-hover:text-accent-foreground' })
        ),
        secondary: 'text-secondary-foreground',
        ghost: 'text-foreground group-active:text-accent-foreground dark:text-primary-foreground',
        link: cn(
